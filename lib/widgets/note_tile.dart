...
class NoteTile extends StatelessWidget {
  ...
  Widget _buildGridTile(BuildContext context, Color noteColor, DateTime lastUpdated) {
    return Container(
  ...
  Widget _buildListTile(BuildContext context, Color noteColor, DateTime lastUpdated) {
    return Container(
